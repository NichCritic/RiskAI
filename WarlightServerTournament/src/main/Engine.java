...
public class Engine {
	...
	public void playRound()
	{
		...
		//System.out.println("attack transfer");
		...
		//System.out.println("end attack transfer");
		moveQueue.clear();
		...
		//System.out.println("hang6");
		//System.out.println("Round: "+Integer.toString(roundNr));
		roundNr++;
	...
	{
		//System.out.println("hang2 1");
		
		sendStartingArmiesInfo(player1);
		//System.out.println("hang2 2");
		sendStartingArmiesInfo(player2);
		//System.out.println("hang2 3");
		sendUpdateMapInfo(player1);
		//System.out.println("hang2 4");
		sendUpdateMapInfo(player2);
		//System.out.println("hang2 5");
		sendOpponentMovesInfo(player1);
		//System.out.println("hang2 6");
		opponentMovesPlayer1.clear();
		//System.out.println("hang2 7");
		sendOpponentMovesInfo(player2);
		//System.out.println("hang2 8");
		opponentMovesPlayer2.clear();
		//System.out.println("hang2 9");
	}
	...
	{
		this.map = null;
		this.fullPlayedGame.clear();
		this.fullPlayedGame = null;
